...
<xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1"
    ...
    <xsl:template name="buildHeader">
            ...
            <div class="navbar navbar-default navbar-static-top" role="navigation">
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <div class="navbar-brand visible-xs visible-sm hidden-md hidden-lg">
				<span class="bold"><i18n:text>xmlui.dri2xhtml.structural.repository.nameabbr</i18n:text></span>
                        </div>
                                ...
                                <form method="post" class="" id="ds-search-form" action="/discover">
                                    <fieldset>
                                        <div class="input-group">
                                            <input placeholder="Search" type="text" class="ds-text-field form-control top-search" name="query" /><span class="input-group-btn"><button title="Go" class="ds-button-field btn btn-primary top-search"><span aria-hidden="true" class="glyphicon glyphicon-search"></span></button></span>
                                        </div>
                                    </fieldset>
                                </form>
                            </li>
        ...
        <div class="container hidden-xs hidden-sm visible-md visible-lg" id="face-wrapper">
    	        ...
    	        <div id="ds-face">
                  <div class="stat-nav">
				<a href="" class="search">Search</a><a href="https://adw-goe.de/en/about-us/contact/">Contact</a>  
				<a href="https://rep.adw-goe.de/feedback">Feedback</a> 
				<ul class="lang-menu">
				<xsl:call-template name="languageSelection"/>	
				</ul>
		  </div> 
	...
	<div class="hidden-print">
		...
		<xsl:text> | </xsl:text>
		<a>
			<xsl:attribute name="href">/bibliography.html</xsl:attribute>
        ...
        <xsl:if test="count(/dri:document/dri:meta/dri:pageMeta/dri:metadata[@element='page'][@qualifier='supportedLocale']) &gt; 1">
            <li id="ds-language-selection" class="dropdown">
			    ...
			    select="/dri:document/dri:meta/dri:pageMeta/dri:metadata[@element='supportedLocale'][@qualifier=$active-locale]"/> -->
				    <xsl:value-of
                            select="translate(/dri:document/dri:meta/dri:pageMeta/dri:metadata[@qualifier='supportedLocale'], 'den', 'DEN')"/>
                        <xsl:text>&#160;</xsl:text>
                        <b class="caret"/>
                    </span>
                </a>
